...
TARGET_CFLAGS:=$(TARGET_OPTIMIZATION)$(if $(CONFIG_DEBUG), -O0 -g3 -ggdb -fsanitize=null -fsanitize-undefined-trap-on-error -fno-omit-frame-pointer, -Os) $(call qstrip,$(CONFIG_EXTRA_OPTIMIZATION))
